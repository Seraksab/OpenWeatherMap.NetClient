...
public interface IOpenWeatherMapClient
{
  ...
  Task<IResponse<CurrentWeather>> CurrentWeatherByName(string name);
  ...
  Task<IResponse<CurrentWeather>> CurrentWeatherByZip(string zip);
  ...
  Task<IResponse<CurrentWeather>> CurrentWeatherByCoordinates(double lat, double lon);
}